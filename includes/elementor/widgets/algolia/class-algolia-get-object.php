 ...
 * @since 0.0.0
 */
class AlgoliaGetObject extends Widget_Base
{
	/**
	 * Class constructor.
	 *
	...
	{
		return __('Algolia Object', 'algolia-get-object');
	}
	...
	protected function _register_controls()
	{
		$this->start_controls_section(
			'section_title',
			[
				'label' => __('Algolia Get Object', 'algolia-wp-plugin'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '<div id="algolia-object"></div>',
