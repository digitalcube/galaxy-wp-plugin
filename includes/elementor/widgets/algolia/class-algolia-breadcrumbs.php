 ...
 * @since 0.0.0
 */
class AlgoliaBreadcrumbs extends Widget_Base
{
	/**
	 * Class constructor.
	 *
	...
	{
		return __('Algolia Breadcrumbs', 'algolia-breadcrumbs');
	}
	...
	protected function _register_controls()
	{
		$this->start_controls_section(
			'section_title',
			[
				'label' => __('Algolia Breadcrumbs', 'algolia-wp-plugin'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '<div id="algolia-breadcrumbs"></div>',
