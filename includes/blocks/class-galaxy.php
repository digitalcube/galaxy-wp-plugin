 ...
 * @link       link(https://github.com/digitalcube/galaxy-wp-plugin, Galaxy for WordPress)
 * @since      0.0.0
 * php version 7.3.9
 */
 ...
 * Main Galaxy Class
 *
 * The init class that runs the Galaxy plugin.
...
final class Galaxy
{
	...
	{
		deactivate_plugins(plugin_basename(GALAXY));
